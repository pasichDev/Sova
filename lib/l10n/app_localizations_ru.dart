...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get resetNetworkDescrpt => 'Сбросить настройки сети, чтобы исправить зависания синхронизации';

  @override
  String get resetNetworkDialog => 'Вы подтверждаете сброс данных подключения к сети?';

  @override
  String get resetNetworkSuccess => 'Да, СБРОСИТЬ!';

  @override
  String get setVerNodes => 'Обновить проверенные узлы';

  @override
  String get setVerNodesDesc => 'Вы можете изменить проверенные узлы, сделайте это, когда приложение не может установить соединение с блокчейном.';

  @override
  String get testVerSeeds => 'Тестировать проверенные узлы';

  @override
  String get testVerSeedsDesc => 'Сделайте это, если не можете подключиться к сети';

  @override
  String get verfNodes => 'Получаем новые узлы с seed.nosocoin.com';
}
